...
app.get('/api/filters', async (req, res) => {
  try {
    ...
    res.json({ states: st.rows, job_types: ty.rows, organizations: or.rows });
  } catch(e) { res.status(500).json({error: e.message}); }
});
